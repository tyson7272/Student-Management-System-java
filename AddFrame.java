...
ActionListener a2 = (ae) -> {
		...
		try
		{
				...
				s.save(stud);
				t.commit();
				JOptionPane.showMessageDialog(c, "Record inserted","Saved !!",JOptionPane.INFORMATION_MESSAGE);
		}
		catch(NumberFormatException e){
				JOptionPane.showMessageDialog(c, "Input cannot be null/alphabetic for rno and marks","Error", JOptionPane.WARNING_MESSAGE);
		}
		//catch(NumberFormatException e){
		//	JOptionPane.showMessageDialog(c, e);
		//}
